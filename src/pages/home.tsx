...
const PREFIXES = [
  "ALPHA","APEX","ARC","ARROW","ASH","ASTRO","ATOM","AURORA","AVALANCHE","AXIS",
  "BANDIT","BARRAGE","BLADE","BLAZE","BLITZ","BOLT","BRAVO","BULLET","BURST","BYTE",
  "CANNON","CARBON","CARNAGE","CIPHER","CLAW","COBRA","COMET","CORE","COSMOS","CRYPTO",
  "CYBER","DAGGER","DARK","DELTA","DEMON","DESTINY","DIAMOND","DYNAMO","EAGLE","ECHO",
  "ECLIPSE","EDGE","EMBER","EMPIRE","ENIGMA","EPIC","EVEREST","FALCON","FANG","FIRE",
  "FIRESTORM","FLARE","FLASH","FORGE","FROST","FURY","GALAXY","GAMBIT","GHOST","GLITCH",
  "GOLIATH","GRAVITY","GUARDIAN","HAMMER","HAVOC","HAWK","HELLFIRE","HORIZON","HUNTER","HYDRA",
  "ICE","ICEBERG","ICON","IMPULSE","INFERNO","IRON","JACKAL","JAGUAR","JAVELIN","JET",
  "JOLT","JUDGMENT","JUNGLE","KILO","KING","KNIGHT","KRAKEN","LEGEND","LEOPARD","LIGHTNING",
  "LIMA","LOCKDOWN","LUNAR","MACHINE","MAMMOTH","MATRIX","MERCURY","METEOR","MIRAGE","MONARCH"
];

const SUFFIXES = [
  "STRIKE","FURY","CORE","STORM","BLADE","VIPER","FORGE","WAVE","PULSE","FANG",
  "HUNTER","SPARK","NEXUS","DRIVE","FLARE","BOLT","ECLIPSE","RIDER","SHIELD","PHASE",
  "VISION","BURST","POINT","CRASH","FORCE","ZONE","SHADOW","THUNDER","REAPER","SPECTER",
  "PHANTOM","TITAN","RAPTOR","OMEGA","DELTA","GHOST","FALCON","DRAGON","BLAZE","VORTEX",
  "TEMPEST","NOVA","QUANTUM","CIPHER","HAVOC","RANGER","SENTINEL","SCORPION","PREDATOR","VELOCITY",
  "WARRIOR","STRIKER","MAVERICK","VANGUARD","OBSIDIAN","TURBO","PYTHON","TORNADO","STEALTH","AVENGER",
  "PALADIN","TITANIUM","LIGHTNING","DOMINATOR","FUSION","OUTLAW","JUGGERNAUT","GLADIATOR","SNIPER","OVERDRIVE",
  "BLACKOUT","FIREBALL","WILDFIRE","HUNTSMAN","BERSERK","NIGHTFALL","EXODUS","CATALYST","SKYWALKER","RICOCHET",
  "STINGER","TRIDENT","WARLOCK","GUARDIAN","RAZOR","THRASHER","SABER","CYCLONE","UPRISING","SLAYER",
  "BLOODHOUND","FRONTIER","HEADHUNTER","STARBREAKER","SHOCKWAVE","PATHFINDER","STARFALL","MOONLIGHT","HELLSTORM","VOID"
];
...
for (let i = 0; i < 1000; i++) {
  ...
  WORDS.push(`${prefix}_${suffix}_${i}`);
}
...
export default function Home() {
  ...
  const startCamera = async () => {
    ...
    if (!isSecure || !navigator.mediaDevices?.getUserMedia) {
      setDecodeError("Live camera needs HTTPS. Use \"Take Photo\" or \"Load Image\" instead.");
      return;
    }
